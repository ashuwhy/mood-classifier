...
async function downloadWithYtDlp(url) {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-C2kb3v_j.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-CVw2QoBz.js").then((n) => n.i);
...
//# sourceMappingURL=main-C-8xrrSb.js.map
