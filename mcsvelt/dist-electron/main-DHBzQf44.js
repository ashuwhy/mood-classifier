...
async function downloadWithYtDlp(url) {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-DWCpgQTd.js").then((n) => n.i);
      ...
      try {
        ...
        console.error("Failed to set FFmpeg path from static or system locations:", err);
        throw new Error("FFmpeg path could not be determined. Ensure ffmpeg is installed and accessible, or ffmpeg-static is working.");
      }
    } catch (error) {
...
//# sourceMappingURL=main-DHBzQf44.js.map
