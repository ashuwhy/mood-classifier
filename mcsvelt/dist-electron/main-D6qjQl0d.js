...
async function downloadWithYtDlp(url) {
  if (!youtubeDlExec) {
    try {
      const ytdlModule = await import("./index-Z2Ft1tAG.js").then((n) => n.i);
      youtubeDlExec = {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-14LVac1J.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-D_lFq0IE.js").then((n) => n.i);
...
//# sourceMappingURL=main-D6qjQl0d.js.map
