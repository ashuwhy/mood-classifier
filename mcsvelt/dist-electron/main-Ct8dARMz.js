...
async function downloadWithYtDlp(url) {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-B3E2tjfe.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-B1Js6_w9.js").then((n) => n.i);
...
//# sourceMappingURL=main-Ct8dARMz.js.map
