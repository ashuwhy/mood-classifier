...
async function downloadWithYtDlp(url) {
  if (!youtubeDlExec) {
    try {
      const ytdlModule = await import("./index-CrJh0O84.js").then((n) => n.i);
      youtubeDlExec = {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-CcDW6MSD.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-DWUxmbIv.js").then((n) => n.i);
...
//# sourceMappingURL=main-Cyanwvnh.js.map
