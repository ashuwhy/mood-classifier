...
async function downloadWithYtDlp(url) {
  if (!youtubeDlExec) {
    try {
      const ytdlModule = await import("./index-DnIjUoNv.js").then((n) => n.i);
      youtubeDlExec = {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-WQkba2h_.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-BxJYyMNi.js").then((n) => n.i);
...
//# sourceMappingURL=main--wkRqP_R.js.map
