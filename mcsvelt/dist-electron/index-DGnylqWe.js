import { c as commonjsGlobal, g as getDefaultExportFromCjs } from "./main-Ctoqr0a3.js";
...
function requireUtils() {
  ...
  hasRequiredUtils = 1;
  require$$0.exec;
  var isWindows = require$$1.platform().match(/win(32|64)/);
    ...
    proto._getFfmpegPath = function(callback) {
      ...
      async2.waterfall([
        ...
        function(ffmpeg, cb) {
          ...
          utils2.which("ffmpeg", function(err, ffmpeg2) {
            cb(err, ffmpeg2);
          });
        }
      ], function(err, ffmpeg) {
        ...
        function(ffprobe2, cb) {
          ...
          self._getFfmpegPath(function(err, ffmpeg) {
            if (err) {
              ...
              var ffprobe22 = path$1.join(path$1.dirname(ffmpeg), name);
    ...
    proto.takeScreenshots = proto.thumbnail = proto.thumbnails = proto.screenshot = proto.screenshots = function(config, folder) {
      ...
      async2.waterfall([
        ...
        for (var i2 = 0; i2 < count; i2++) {
          ...
          self.output(path$1.join(config.folder, filenames[i2])).frames(1).map(stream);
          if (i2 > 0) {
...
const index = /* @__PURE__ */ getDefaultExportFromCjs(fluentFfmpegExports);
...
//# sourceMappingURL=index-DGnylqWe.js.map
