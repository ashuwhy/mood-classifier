...
async function downloadWithYtDlp(url) {
  if (!youtubeDlExec) {
    try {
      youtubeDlExec = await import("./index-DqBAFEzA.js").then((n) => n.i);
    } catch (error) {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-Ds49Ohfa.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-CaO21F0q.js").then((n) => n.i);
...
//# sourceMappingURL=main-DghgrQbf.js.map
