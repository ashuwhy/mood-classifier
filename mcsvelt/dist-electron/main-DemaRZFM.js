...
async function downloadWithYtDlp(url) {
  if (!youtubeDlExec) {
    try {
      youtubeDlExec = await import("./index-DOm_C-HK.js").then((n) => n.i);
    } catch (error) {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-C-lRHsue.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-BDzrhavm.js").then((n) => n.i);
...
//# sourceMappingURL=main-DemaRZFM.js.map
