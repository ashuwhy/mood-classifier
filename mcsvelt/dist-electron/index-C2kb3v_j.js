import { c as commonjsGlobal, g as getDefaultExportFromCjs } from "./main-C-8xrrSb.js";
        ...
        function(ffprobe2, cb) {
          ...
          self._getFfmpegPath(function(err, ffmpeg) {
            if (err) {
              ...
              var ffprobe22 = path.join(path.dirname(ffmpeg), name);
  ...
  ffprobe = function(proto) {
    proto.ffprobe = function() {
      ...
      this._getFfprobePath(function(err, path) {
        ...
        var ffprobe2 = spawn(path, ["-show_streams", "-show_format"].concat(options, src), { windowsHide: true });
        if (input.isStream) {
...
//# sourceMappingURL=index-C2kb3v_j.js.map
