...
async function downloadWithYtDlp(url) {
  if (!youtubeDlExec) {
    try {
      const ytdlModule = await import("./index-DePzoTfb.js").then((n) => n.i);
      youtubeDlExec = ytdlModule.default;
    } catch (error) {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-NRI2gBxX.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-DjHOfqUu.js").then((n) => n.i);
...
//# sourceMappingURL=main-zZ38j25x.js.map
