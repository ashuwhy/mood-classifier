...
async function downloadWithYtDlp(url) {
  if (!youtubeDlExec) {
    try {
      const ytdlModule = await import("./index-gdJ6tQe7.js").then((n) => n.i);
      const binPath = path.join(__dirname, "../node_modules/youtube-dl-exec/bin");
      youtubeDlExec = {
        default: ytdlModule.default,
        create: ytdlModule.create
      };
      if (!youtubeDlExec.default) {
        const binaryPath = path.join(binPath, process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp");
        console.log("Creating youtube-dl-exec with binary path:", binaryPath);
        youtubeDlExec.default = ytdlModule.create(binaryPath);
      }
    } catch (error) {
  ...
  if (!ffmpeg) {
    try {
      const ffmpegImport = await import("./index-5arXU5WK.js").then((n) => n.i);
      ffmpeg = ffmpegImport.default;
      try {
        const ffmpegStaticImport = await import("./index-CR_MgLDf.js").then((n) => n.i);
...
//# sourceMappingURL=main-DHgAiuQ2.js.map
